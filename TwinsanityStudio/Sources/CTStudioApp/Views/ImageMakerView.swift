...
struct ImageMakerView: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 16) {
            ...
            Text("Builds a complete, real ISO-9660 (ECMA-119) disc image from a folder of files — every directory record round-trips through this app's own disc-image reader, verified the same way every other writer in this app is. Whether the result actually boots on real PS2 hardware or in an emulator hasn't been tested; that verification needs hardware this project has no access to.")
                .font(.caption)
